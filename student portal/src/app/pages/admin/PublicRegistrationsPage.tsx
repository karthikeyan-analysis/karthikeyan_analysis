...
export default function PublicRegistrationsPage() {
  ...
  const handleDownloadPDF = async (student: Row) => {
    ...
    try {
      ...
      pdf.save(`hall-ticket-${student.username}-${student.name.replace(/\s+/g, "_")}.pdf`);
    } catch (e) {
          ...
          {loading ? (
            ...
            <table className="w-full text-sm min-w-[1000px]">
              <thead className="bg-slate-50 border-b border-slate-200">
                <tr>
                  {["#", "Username", "Name", "Phone", "District", "Qual.", "Subjects", "KA?", "Registered", "Passcode", "Hall Ticket"].map((h) => (
                  ...
                  <tr key={r.id} className="hover:bg-slate-50 transition">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1.5">
                        <span className={`font-mono text-sm ${revealId === r.id ? "text-slate-900 font-semibold" : "text-transparent bg-slate-200 rounded select-none"}`}>
                          {r.passcode}
                        </span>
                        <button
                          type="button"
            ...
            <DialogHeader className="no-print flex flex-row items-center justify-between pb-3 border-b border-slate-200">
              <div>
                ...
                <p className="text-xs text-slate-500 font-mono">
                  Username: {selectedStudent.username} · Passcode: {selectedStudent.passcode}
                </p>
              </div>
              <div className="flex items-center gap-2">
                <Button
              ...
              >
                  ...
                  <div className="flex-1 p-5">
                    <table className="w-full text-sm">
                      <tbody className="divide-y divide-slate-100">
                        ...
                        <InfoRow label="Native District" value={selectedStudent.nativeDistrict} />
                ...
                <div className="border-t border-slate-200 px-5 pb-5 pt-3 bg-white">
                  ...
                  <ol className="list-decimal list-inside text-xs text-slate-600 space-y-1">
                    <li>
                      Take this CBT test on <strong>Laptop / Desktop</strong> only.
                    </li>
                    ...
                    <li>
                      Attend the <strong>discussion session</strong> after each exam.
                    </li>
                    <li>
                      Test links will be shared on the <strong>Telegram channel</strong> only.
                    </li>
