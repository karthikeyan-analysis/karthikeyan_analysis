...
export interface Student {
  ...
  /**
   * Username for portal username/password login (fallback when Google login fails).
   * Stored lowercase, e.g. "ka-0042". Generated by admin.
   */
  portalUsername?: string;
  /**
   * Plaintext password for portal login. Admin-generated simple passcode.
   * Never displayed to students except when the admin copies and shares it.
   */
